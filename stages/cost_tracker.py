"""
Cost Tracker — ContentMatrix OS

Tracks token usage and cost for every LLM + Serper call.
Pricing reflects 2026 published rates — review quarterly.

Usage:
    from stages.cost_tracker import tracker
    tracker.log_llm_call("section_writer", "gemini-2.0-flash", 1200, 800)
...
PRICING = {
    ...
    "gemini-1.5-pro":    {"input":  1.25,  "output": 5.00},   # legacy
    # Serper.dev
    "serper":            {"per_call": 0.001},  # paid plan; free tier = $0
}
...
class CostTracker:
    ...
    def print_report(self):
        ...
        print(f"\n{sep}")
        print("  ContentMatrix OS — COST REPORT")
